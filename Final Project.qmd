  ...
  output$myPlot <- renderPlotly({
    league_data <- switch(
      ...
      "Premier League" = switch(
        ...
        "Midfielders" = complete_prem_attackers
      ),
      "La Liga" = switch(
        input$position,
        "Attackers" = complete_la_liga_attackers,
        "Midfielders" = complete_la_liga_attackers
      ),
      "Bundesliga" = switch(
        input$position,
        "Attackers" = complete_bundesliga_attackers,
        "Midfielders" = complete_bundesliga_attackers
      ),
      "Serie A" = switch(
        input$position,
        "Attackers" = complete_serie_a_attackers,
        "Midfielders" = complete_serie_a_attackers
      ),
      "Ligue 1" = switch(
        input$position,
    ...
    plot_ly(data = league_data, x= ~transfer_fee, y= ~GA_minus_xGA, color = ~LastName, text= ~team_name, type= "scatter", mode = "markers", marker = list(size = 10, symbol = "circle"))|>
      layout(
        title = paste(input$position, input$league),
